...
const Messages = () => {
    ...
    const fetchFriends = async () => {
        try {
            const response = await axios.get(`${import.meta.env.VITE_Backend_Url}/api/messages/friends/${currentUser.user_id}`);
    ...
    const fetchMessages = async (friendId) => {
        ...
        try {
            const response = await axios.get(`${import.meta.env.VITE_Backend_Url}/api/messages/${currentUser.user_id}/${friendId}`);
    ...
    const handleSendMessage = async () => {
        ...
        try {
            const response = await axios.post(`${import.meta.env.VITE_Backend_Url}/api/messages/send`, {
                senderId: currentUser.user_id,
                receiverId: selectedFriend.user_id,
                content: text
            });
